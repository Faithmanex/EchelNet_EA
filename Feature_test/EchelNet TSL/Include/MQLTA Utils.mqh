...
#property description   ""
#property description   ""
#property description   "MQLTA Utils"
...
bool UpdateCheckOver(string Name, datetime ExpiryDate, bool ShowAlert){
   if(TimeCurrent()>ExpiryDate){
      ...
      string AlertText="Version Expired, contact EchelNet Ltd";
...
void UpdateCheckWarning(string Name, datetime WarnDate, datetime ExpDate, bool ShowAlert){
   if(TimeCurrent()>WarnDate){
      ...
      string AlertText="This Product Version Will Stop Working On The "+WarningDateStr+", Please Download contact EchelNet Ltd.";
      DrawExpiry(Name,EditText); 
      if(ShowAlert){
         Alert(AlertText);
         Print(AlertText);    
